...
import { BarChart3, Bot, Briefcase, CalendarCheck, FileBarChart, FolderTree, LayoutDashboard, Settings, Sparkles, TimerReset, Users, Wrench } from "lucide-react";
...
const items: NavItem[] = [
  ...
  { to: "/org-admin/ai", label: "AI Recommendations", icon: Bot },
